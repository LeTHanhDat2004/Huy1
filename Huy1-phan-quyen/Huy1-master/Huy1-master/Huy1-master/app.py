    ...
    with db.cursor() as cursor:
        cursor.execute("""
            SELECT 
                ...
                s.SalaryMonth as month,
                s.BaseSalary as basic_salary,
                s.Bonus as allowances,
                s.Deductions as deductions,
                s.NetSalary as net_salary,
                'Paid' as status
            FROM salaries s
...
@app.route('/delete-payroll/<int:id>')
